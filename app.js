...
const asobibaSrcManagerFunction = require('./asobiba-src-manager-function');

const app = express();
const { asobibaSrcHandler, asobibaSrcRouter } = asobibaSrcManagerFunction();
